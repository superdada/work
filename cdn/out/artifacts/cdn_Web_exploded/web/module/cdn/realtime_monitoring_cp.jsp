...
<div id="my-m2-vm">
    ...
    <div class="my-switch-box">
        <div class="my-switch-item">
            ...
            <ul class="my-switch-options">
                <li v-for="cdn in cdn_cache_all" v-on:click="switch('cdn',cdn.type,_vmData)"
    ...
    <div id="my-m2-submodule2" class="tbback-tabs">
        <ul class="tbback-nav-tabs">
            <li v-for="index in m2_indexes" v-on:click="m2_switch_index(index.type)"
                v-bind:class="{'tbback-nav-tabs-selected':curr_m2_index==index.type,'tbback-nav-tabs-unselected':curr_m2_index!=index.type}">
                {{index.text}}
            </li>
    ...
    <div id="my-m2-submodule3" class="tbback-tabs">
        <ul class="tbback-nav-tabs">
            <li v-for="index in m3_indexes" v-on:click="m3_switch_index(index.type)"
                v-bind:class="{'tbback-nav-tabs-selected':curr_m3_index==index.type,'tbback-nav-tabs-unselected':curr_m3_index!=index.type}">
                {{index.text}}
            </li>
        </ul>
        ...
        $.ajax({
            ...
            success: function (Response) {
                ...
                if (moduleId == 1) {
                    ...
                    var _data = {
                        'data': [
                            {'value': vm.module1_data.health_rate, 'name': 'health'},
                            {'value': 100 - vm.module1_data.health_rate, 'name': ''}
                        ],
                        'others': {
                            color: vm.m1_health_rate_color
                        }
                    };
                    vm.charts.chart1 = chartFactory(vm.charts_config.chart1.type, vm.charts_config.chart1.domID, _data);
                    /*子模块1 命中率 图表*/
                    _data = {
                        'data': [
                            {'value': vm.module1_data.hit_rate, 'name': 'hit rate'},
                            {'value': 100 - vm.module1_data.hit_rate, 'name': ''}
                        ],
                        'others': {
                            color: vm.m1_hit_rate_color
                        }
                    };
                    vm.charts.chart2 = chartFactory(vm.charts_config.chart2.type, vm.charts_config.chart2.domID, _data);
                    /*子模块1 速率 图表*/
                    _data = {
                        'data': [
                            {'value': vm.module1_data.avg_dl_speed, 'name': '下载速率'}],
                        'others': {
                            thresholds: vm.thresholds.avg_dl_speed
                        }
                    };
                    vm.charts.chart3 = chartFactory(vm.charts_config.chart3.type, vm.charts_config.chart3.domID, _data);
                } else if (moduleId == 2) {
        ...
        var vm = new Vue({
            ...
            methods: {
                switch: function (_type, _option) {
                    ...
                    requestUtil('/realtimeonline.do?method=request1', requestParams, vm, 1);
                    requestUtil('/realtimeonline.do?method=request2', requestParams, vm, 2);
                    requestUtil('/realtimeonline.do?method=request3', requestParams, vm, 3);
                },
